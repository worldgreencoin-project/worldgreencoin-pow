...
static const int64 nTargetSpacing = 60; // WorldGreenCoin: 1 minute block
...
bool CBlock::CheckBlock(CValidationState &state, bool fCheckPOW, bool fCheckMerkleRoot) const
{
    ...
    // WorldGreenCoin: Special short-term limits to avoid 10,000 BDB lock limit:
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x42a73c67489b3a7d418714bd8e39c5b90145d1dad81d652f2a8a2509fb6b0545");
    }
...
bool CheckWork(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    // Found a solution
    {
        ...
        if (pblock->hashPrevBlock != hashBestChain)
            return error("WorldGreenCoinMiner : generated block is stale");
